...
This repository, `phylocontrol.geninput`, contains the four Quarto notebooks to generate inputs for the R Shiny visualisation application available from the [`phylocontrol.viz` repository](https://github.com/csiro/phylocontrol.viz).
