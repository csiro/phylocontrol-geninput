...
Don't forget to include an appropriate outgroup in your species list so that the tree can be rooted. They should be known to be outside of the study group but closely related to it. One or more outgroup species can be appended manually to the output csv file, if an outgroup is not already included. The output file will be saved to the folder named the study group.
